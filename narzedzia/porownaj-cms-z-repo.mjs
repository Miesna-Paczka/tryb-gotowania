...
const SUROWE = {
  ...
  /* `liczba-porcji` NIE MA TU CELOWO. Przebieg jednego dnia, 2026-08-24: pole
     skasowano, założono ponownie (Webflow trzyma stary slug jako zajęty, więc nowe
     dostało `liczba-porcji-2`), po czym skasowano także tamto — świadomie,
     bo nie miało odbiorcy: żaden szablon ani skrypt go nie czytał.
     Zmierzone odczytem schematu kolekcji 2026-08-24 17:15: w kolekcji `przepisy`
     jest 31 pól i nie ma wśród nich ani `liczba-porcji`, ani `liczba-porcji-2`.
     Wpisanie tu któregokolwiek z nich daje 16 fałszywych rozjazdów naraz — CMS
     zwróci `undefined`, a plik źródłowy ma wartość, bo w `[meta]` klucz ZOSTAJE
     jako informacja redakcyjna („2–3 porcje" niesie to, czego `porcje-bazowe`
     nie wyraża). Kierunek prawdy jest tu jednostronny: plik ma, CMS nie chce. */
};
